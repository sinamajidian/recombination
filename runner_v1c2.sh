...
grep -n ">" sim1.fasta
grep -n ">" sim2.fasta
sed -n 1,210000p sim1.fasta > sim1_swap.fa
sed -n '210001,$p' sim2.fasta >> sim1_swap.fa
sed -n 1,210000p sim2.fasta > sim2_swap.fa
sed -n '210001,$p' sim1.fasta >> sim2_swap.fa
