...
echo "###### genome simulation mother father child #######"
echo "####################################################"
...
grep -n ">" sim1.fasta
grep -n ">" sim2.fasta
sed -n 1,250000p sim1.fasta > sim1_swap.fa
sed -n '250001,$p' sim2.fasta >> sim1_swap.fa
sed -n 1,250000p sim2.fasta > sim2_swap.fa
sed -n '250001,$p' sim1.fasta >> sim2_swap.fa
...
grep -n ">" sim1.fasta
grep -n ">" sim2.fasta
sed -n 1,410000p sim1.fasta > sim1_swap.fa
sed -n '410001,$p' sim2.fasta >> sim1_swap.fa
sed -n 1,410000p sim2.fasta > sim2_swap.fa
sed -n '410001,$p' sim1.fasta >> sim2_swap.fa
...
echo "##########  read simulation child  mother father  #######"
echo "#########################################################"
...
#cat sim_Mh1_0001.fastq sim_Fh1_0001.fastq  > reads.fastq
...
#cat sim_Mh1_0001.fastq sim_Mh2_0001.fastq  > reads_M.fastq
...
#cat sim_Fh1_0001.fastq   sim_Fh2_0001.fastq > reads_F.fastq 
...
echo "#########  mapping phasing of mother father ######"
echo "##################################################"
